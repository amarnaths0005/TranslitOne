...
function setupGurmukhiMaps() {
  ...
  gurmukhiVowels.set("O", "\u0A13");
  gurmukhiVowels.set("\xd1", "\u0A14"); // au, ou
  ...
  gurmukhiConsonants.set("\xd9", "\u0A36"); // Sh
  ...
  gurmukhiKaagunita.set("\xd0", "\u0A42"); // RU
  gurmukhiKaagunita.set("e", "\u0A47");
  gurmukhiKaagunita.set("E", "\u0A47");
  gurmukhiKaagunita.set("\xd2", "\u0A48"); // ai
  gurmukhiKaagunita.set("o", "\u0A4B");
  gurmukhiKaagunita.set("O", "\u0A4B");
  gurmukhiKaagunita.set("\xd1", "\u0A4C"); // au
