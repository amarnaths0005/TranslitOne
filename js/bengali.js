...
function setupBengaliMaps() {
  ...
  bengaliConsonants.set("\xd9", "\u09B7"); // Sh
  ...
  bengaliKaagunita.set("\xd0", "\u09C4"); // RU
  bengaliKaagunita.set("e", "\u09C7");
  bengaliKaagunita.set("E", "\u09C7");
  bengaliKaagunita.set("\xd2", "\u09C8"); // ai
  bengaliKaagunita.set("o", "\u09CB");
  bengaliKaagunita.set("O", "\u09CB");
  bengaliKaagunita.set("\xd1", "\u09CC"); // au
