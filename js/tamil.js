...
function setupTamilMaps() {
  ...
  tamilConsonants.set("\xd7", "\u0B99"); // ng

  tamilConsonants.set("c", "\u0B9A"); // Also ch
  tamilConsonants.set("C", "\u0B9A"); // Also Ch
  tamilConsonants.set("j", "\u0B9C");
  tamilConsonants.set("J", "\u0B9C");
  tamilConsonants.set("\xd8", "\u0B9E"); // ny

  tamilConsonants.set("T", "\u0B9F");
  tamilConsonants.set("\xd3", "\u0B9F"); // Th
  tamilConsonants.set("D", "\u0B9F");
  tamilConsonants.set("\xd4", "\u0B9F"); // Dh
  tamilConsonants.set("N", "\u0BA3");

  tamilConsonants.set("t", "\u0BA4");
  tamilConsonants.set("\xd5", "\u0BA4"); // th
  tamilConsonants.set("d", "\u0BA4");
  tamilConsonants.set("\xd6", "\u0BA4"); // dh
  tamilConsonants.set("\xda", "\u0BA8");
