...
function setupMalayalamMaps() {
  ...
  malayalamVowels.set("\xd1", "\u0D14"); // au, ou
  ...
  malayalamConsonants.set("\xd7", "\u0D19"); // ng
  ...
  malayalamConsonants.set("\xd8", "\u0D1E"); // ny

  malayalamConsonants.set("T", "\u0D1F");
  malayalamConsonants.set("\xd3", "\u0D20"); // Th
  malayalamConsonants.set("D", "\u0D21");
  malayalamConsonants.set("\xd4", "\u0D22"); // Dh
  malayalamConsonants.set("N", "\u0D23");

  malayalamConsonants.set("t", "\u0D24");
  malayalamConsonants.set("\xd5", "\u0D25"); // th
  malayalamConsonants.set("d", "\u0D26");
  malayalamConsonants.set("\xd6", "\u0D27"); // dh
  ...
  malayalamConsonants.set("\xd9", "\u0D37"); // Sh
