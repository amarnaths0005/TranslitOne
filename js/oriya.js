...
function setupOdiaMaps() {
  ...
  odiaKaagunita.set("\xd0", "\u0B44"); // RU
  odiaKaagunita.set("e", "\u0B47");
  odiaKaagunita.set("E", "\u0B47");
  odiaKaagunita.set("\xd2", "\u0B48"); // ai
  odiaKaagunita.set("o", "\u0B4B");
  odiaKaagunita.set("O", "\u0B4B");
  odiaKaagunita.set("\xd1", "\u0B4C"); // au
