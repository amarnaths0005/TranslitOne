...
function setupDevanagariMaps() {
  ...
  devanagariVowels.set("E", "\u090F");
  devanagariVowels.set("\xd2", "\u0910"); // ai
  devanagariVowels.set("o", "\u0913");
  devanagariVowels.set("O", "\u0913");
  devanagariVowels.set("\xd1", "\u0914"); // au, ou
  ...
  devanagariConsonants.set("\xd7", "\u0919"); // ng
  ...
  devanagariConsonants.set("\xd8", "\u091E"); // ny

  devanagariConsonants.set("T", "\u091F");
  devanagariConsonants.set("\xd3", "\u0920"); // Th
  devanagariConsonants.set("D", "\u0921");
  devanagariConsonants.set("\xd4", "\u0922"); // Dh
  devanagariConsonants.set("N", "\u0923");

  devanagariConsonants.set("t", "\u0924");
  devanagariConsonants.set("\xd5", "\u0925"); // th
  devanagariConsonants.set("d", "\u0926");
  devanagariConsonants.set("\xd6", "\u0927"); // dh
  ...
  devanagariConsonants.set("\xd9", "\u0937"); // Sh
  ...
  devanagariKaagunita.set("\xd0", "\u0944"); // RU
  devanagariKaagunita.set("e", "\u0947");
  devanagariKaagunita.set("E", "\u0947");
  devanagariKaagunita.set("\xd2", "\u0948"); // ai
  devanagariKaagunita.set("o", "\u094B");
  devanagariKaagunita.set("O", "\u094B");
  devanagariKaagunita.set("\xd1", "\u094C"); // au
